...
load_if_possible = T # if saved transformed df is found, load instead of compute
...
```{r}
getwd()
dat = read_rds(here("input","sequence_data_240515","4_data_AUD diagnosis and intervention sequences_2024-05-15.rds")) 
...
ggsave(paste0("output/","figures/","fig_classes_lineplot_class6.png"), width = 10, height = 6)
```
